...
const StressTest = ({
  ...
  return (
    <div className="max-w-5xl mx-auto p-4 sm:p-6 font-mono mb-72">
      <div className="bg-white rounded-2xl p-6 sm:p-12 shadow-xl border border-gray-100">
        ...
        <p className="text-sm sm:text-base text-gray-600 mb-8 sm:mb-10">
          Just a few quick questions to get a feel for what you need. Your
          answers help me tailor the support to what matters most to you.
        </p>
